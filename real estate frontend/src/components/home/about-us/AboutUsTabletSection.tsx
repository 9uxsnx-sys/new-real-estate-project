...
interface AboutUsTabletSectionProps {
  className?: string;
  lang?: string;
}

/**
 * About Us Section - Tablet Version
 * 
 * Clean tablet design based on mobile structure.
 * Features headline with icons and 3 info cards.
 * Headline size matches Services/Gateway/Faq tablet sections.
 */
...
export const AboutUsTabletSection: React.FC<AboutUsTabletSectionProps> = ({ className = '', lang = 'en' }) => {
  ...
  return (
    <section 
      id="about-us"
      className={`w-full bg-white px-14 py-20 ${className}`}
      style={fontStyle}
    >
      {/* About Us Label */}
      ...
      {/* Headline - Stack vertically, centered, larger size for tablet */}
      <div className="flex flex-col items-center gap-4 mb-10">
        {/* Line 1 */}
        <h2 className="text-neutral-900 tracking-[-0.06em] text-5xl font-medium leading-[117%] text-center text-wrap:balance px-2" style={fontStyle}>
          {content.line1}
        </h2>

        {/* Line 2: text + icon + text - all on ONE row */}
        <div className="flex items-center justify-center gap-2 w-full px-2 flex-wrap">
          <span className="text-neutral-900 tracking-[-0.06em] text-5xl font-medium leading-[117%] text-center text-wrap:balance" style={fontStyle}>
            {content.line2a}
          </span>
          <HomeIcon />
          <span className="text-neutral-900 tracking-[-0.06em] text-5xl font-medium leading-[117%] text-center text-wrap:balance" style={fontStyle}>
        ...
        <div className="flex items-center justify-center gap-2 w-full px-2 flex-wrap">
          <span className="text-neutral-900/50 tracking-[-0.06em] text-5xl font-medium leading-[117%] text-center text-wrap:balance" style={fontStyle}>
            {content.line3a}
          </span>
          <ShieldIcon />
          <span className="text-neutral-900/50 tracking-[-0.06em] text-5xl font-medium leading-[117%] text-center text-wrap:balance" style={fontStyle}>
      ...
      <div className="flex flex-col gap-6 max-w-screen-md mx-auto">
        ...
        <div className="bg-zinc-100 rounded-3xl p-6">
          <div className="flex flex-col gap-3">
            ...
            <p className={`text-neutral-900 text-7xl font-medium ${lang === 'ar' ? 'text-right' : 'text-left'}`} style={fontStyle}>
              2013
            </p>
          </div>
        ...
        <div className="bg-neutral-900 rounded-3xl p-6">
          <div className="flex items-center justify-between w-full">
            ...
            <p className="text-white text-6xl font-medium" style={fontStyle}>
              {projects.value}
            </p>
          </div>
        </div>
