...
const getFooterContent = (lang: string) => {
  const content = {
    ...
    fr: {
      logoText: 'Aeline',
      description: 'Développeur de projets résidentiels et commerciaux d\'exception à Alger et Boumerdès depuis 2013. Nous bâtissons votre confiance avant de bâtír votre projet.',
      navLinks: [
        { label: 'Accueil', href: '/' },
...
export const FooterMobileSection: React.FC<FooterMobileSectionProps> = ({ 
  ...
  return (
    <footer 
      ...
      dir={isRTL ? 'rtl' : 'ltr'}
    >
      {/* Dark Container - Stacked layout for mobile */}
      <div className="w-full max-w-screen-2xl mx-auto flex flex-col gap-8 p-8 bg-neutral-900 rounded-3xl">
        ...
        <p 
          className="text-white tracking-[-0.02em] text-wrap text-base leading-6"
          style={{ fontFamily: 'Inter, sans-serif' }}
        >
          {content.description}
        </p>
